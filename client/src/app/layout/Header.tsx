...
import { AppBar, Badge, Box, IconButton, List, ListItem, Switch, Toolbar, Typography, styled } from "@mui/material";
    ...
    <AppBar position="static" sx={{ mb: 4 }}>
      <Toolbar sx={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
        <Box display="flex" alignItems="center">
          <Typography variant="h6" component={NavLink} to="/" sx={navLinkStyles}>
            RE-STORE
          </Typography>
...
const MaterialUISwitch = styled(Switch)(({ theme }) => ({
  ...
  "& .MuiSwitch-thumb": {
    backgroundColor: theme.palette.mode === "dark" ? "#0288d1" : "#fb8c00",
    width: 32,
    height: 32,
    "&::before": {
      content: "''",
